...
# day 1
- Today was about understanding the concept of python, why it was created, and its installation and getting conversant with the workspace/environment. i learnt how to use print() to relay/ view code on the terminal.

# day 2
- Today I learned that variables are like labeled boxes that store values.
